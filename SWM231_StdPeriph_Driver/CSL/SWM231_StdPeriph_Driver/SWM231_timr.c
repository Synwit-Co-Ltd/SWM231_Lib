...
/*******************************************************************************************************************************
* @brief	Timer init
* @param	TIMRx is timer to init, can be TIMR0 and BTIMR0~2
* @param	mode for TIMR0 can be TIMR_MODE_TIMER, TIMR_MODE_COUNTER, TIMR_MODE_OC and TIMR_MODE_IC
*			mode for BTIMR0~2 can be TIMR_MODE_TIMER and TIMR_MODE_OC
...
/*******************************************************************************************************************************
* @brief	Timer start
* @param	TIMRx is timer to start, can be TIMR0 and BTIMR0~2
* @return
*******************************************************************************************************************************/
...
/*******************************************************************************************************************************
* @brief	Timer stop
* @param	TIMRx is timer to stop, can be TIMR0 and BTIMR0~2
* @return
*******************************************************************************************************************************/
...
* @param	TIMRx is timer to halt, can be TIMR0
* @return
*******************************************************************************************************************************/
...
* @param	TIMRx is timer to resume, can be TIMR0
* @return
*******************************************************************************************************************************/
...
* @param	TIMRx is timer to query, can be TIMR0 and BTIMR0~2
...
* @param	TIMRx is timer to set, can be TIMR0 and BTIMR0~2
* @param	it for TIMR0 can be TIMR_IT_TO, TIMR_IT_OC, TIMR_IT_IC_LOW, TIMR_IT_IC_HIGH and their '|' operation
*			it for BTIMR0~2 can be TIMR_IT_TO, TIMR_IT_OC and their '|' operation
* @return
*******************************************************************************************************************************/
...
* @param	TIMRx is timer to init, can be TIMR0
